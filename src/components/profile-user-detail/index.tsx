...
//                 />
//                 {/* {console.log(post?.filePost?.length)} */}
//                 {post?.filePost?.map((photo: any) =>
//                   <>
//                     {/* {console.log(photo)} */}
//                     <Image width={'50%'} key={photo?.id}  src={`data:image/png;base64, ${photo?.dataFile}`} alt="post photo" />
//                   </>)}
//                 <CardContent>
...
import { useCheckIsFollowing, useGetFollowerByUser, useGetFollowingByUser } from '@/view/user/hooks/useGetFollow';
import { useGetPostByUserId } from '@/view/user/hooks/useGetPostByUser';
import { Button, Card, CardActions, CardContent, CardHeader, CircularProgress, Divider, IconButton, Typography } from '@mui/material';
import MoreVertIcon from '@mui/icons-material/MoreVert';
import FavoriteIcon from '@mui/icons-material/Favorite';
import ShareIcon from '@mui/icons-material/Share';
import Cookies from 'js-cookie'
                ...
                <ImageContainer>
                  ...
                  {post?.filePost?.map((photo: any) =>
                    <StyledImage
                      ...
                      alt="post photo"
                      isLarge={post?.filePost?.length >= 2}
                    />
                  )}
                </ImageContainer>
                <CardContent>
